...
export const translations = {
    en: {
        ...
        input: {
            ...
            placeholder: "Paste text, screenshots, PDFs, Word docs, or notes here...",
            ...
            attachFiles: "Upload",
            supportedFilesHint: "Images use local OCR; TXT/Markdown/CSV import directly. PDF and Word extraction are still demo placeholders.",
            ...
            documentStubText: "Imported document",
            documentDemoNotice: "(Demo document extraction) Review and edit this placeholder text before generating.",
            ...
            aiModePrivacy: "Initializing sends a locally compacted copy of the editable study text to your selected AI provider. Do not include identifiable learner or classroom data.",
    ...
    zh: {
        ...
        input: {
            ...
            documentStubText: "已导入文档",
            documentDemoNotice: "（演示文档解析）请在生成前检查并编辑这段占位文字。",
            ...
            aiModePrivacy: "初始化任务会先在本地压缩当前可编辑的学习资料，再发送给你选择的 AI 服务；请勿包含可识别的学习者或班级信息。",
            analyzing: "正在分析情报...",
            initialize: "初始化任务",
            error: "任务生成失败。请重试。",
