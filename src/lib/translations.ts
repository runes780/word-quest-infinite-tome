...
export const translations = {
    en: {
        ...
        input: {
            ...
            localModeDescription: "Start a short retrieval quest now. AI is optional and only needed to turn your own material into new questions.",
            startLocalQuest: "Start local quest",
            connectAi: "Connect AI",
            localModePrivacy: "The local quest uses synthetic built-in content. Learning records stay on this device, and nothing is sent to an AI provider.",
            ...
            briefTargets: "Candidate targets",
            briefRemoveTarget: "Remove target",
            briefRestoreTarget: "Restore target",
            briefMinTargets: "Keep at least 3 targets to start.",
    ...
    zh: {
        ...
        input: {
            ...
            localModeDescription: "现在就能开始一组短时提取练习。AI 是可选功能，仅在把自有资料生成新题时需要。",
            startLocalQuest: "开始本地练习",
            connectAi: "连接 AI",
            localModePrivacy: "本地练习使用内置合成内容；学习记录只保存在此设备，不会发送给 AI 服务。",
            ...
            briefDifficulty: "难度带",
            briefTargets: "候选学习目标",
            briefRemoveTarget: "移除目标",
            briefRestoreTarget: "恢复目标",
            briefMinTargets: "至少保留 3 个目标才能开始。",
            briefStart: "开始任务",
            briefCancel: "取消",
