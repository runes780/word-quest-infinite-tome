...
export const translations = {
    en: {
        ...
        input: {
            ...
            imageHint: "OCR is currently in demo mode in this build; recognized text is a placeholder.",
            ...
            imageDemoNotice: "(Demo OCR) Please edit this text manually before generating.",
