...
export const translations = {
    en: {
        ...
        input: {
            ...
            placeholder: "Paste text, screenshots, or notes here...",
            materialComposerLabel: "Learning material composer",
            materialComposerTitle: "Paste or upload material",
            materialHint: "Paste, drag, or upload screenshots and notes. Image OCR runs locally; extracted text stays editable.",
            attachFiles: "Upload",
            supportedFilesHint: "Images use local OCR; TXT/Markdown/CSV import directly. PDF and Word extraction is not supported yet.",
            attachmentListLabel: "Attached study materials",
            attachmentExtracting: "Extracting text...",
            attachmentReady: "Text inserted",
            attachmentUnsupported: "Unsupported file type",
            attachmentDocumentUnsupported: "PDF and Word files are not supported yet. Paste or upload the text instead.",
            attachmentError: "Could not extract text",
            removeAttachment: "Remove",
            textFileImported: "Imported text file",
            configureKey: "Configure API Key to Start",
            localModeTitle: "Local practice is ready",
            localModeDescription: "Start a short retrieval quest built from your own pasted material — no AI key needed. AI is optional and only adds extra missions.",
            startLocalQuest: "Start local quest",
            connectAi: "Connect AI",
            localModePrivacy: "Local quests use your own material. Learning records stay on this device, and nothing is sent to an AI provider.",
            localMaterialTitle: "Local quest from your material",
            localMaterialStart: "Start local quest from this material",
            localMaterialHint: "Runs entirely on this device — no AI key needed. Questions are built from your own text.",
            briefTitle: "Learning brief",
            briefLanguage: "Material language",
            briefDifficulty: "Difficulty band",
            briefTargets: "Suggested practice items",
            briefRemoveTarget: "Remove item",
            briefRestoreTarget: "Restore item",
            briefMinTargets: "Keep at least 3 suggested practice items to start.",
            briefStart: "Start quest",
            briefCancel: "Cancel",
            localQuestBuildError: "This material could not produce a full local quest. Add a few more sentences, or use the AI mission instead.",
            aiOptionalHint: "AI mission is an optional enhancement. The local quest above needs no key.",
            ...
            imageHint: "Images are recognized locally in your browser. Review the extracted text before generating.",
            ...
            imageStubText: "OCR text from image",
            imageDemoNotice: "Review and edit the recognized text before generating.",
    ...
    zh: {
        ...
        input: {
            ...
            placeholder: "在此粘贴课文、截图或学习笔记...",
            materialComposerLabel: "学习资料输入器",
            materialComposerTitle: "粘贴或上传学习资料",
            materialHint: "可直接粘贴、拖拽或上传截图与笔记；图片会在本地 OCR，提取出的文字仍可编辑。",
            attachFiles: "上传",
            supportedFilesHint: "图片会走本地 OCR；TXT/Markdown/CSV 会直接导入。PDF 和 Word 暂不支持。",
            attachmentListLabel: "已添加的学习资料",
            attachmentExtracting: "正在提取文字...",
            attachmentReady: "文字已插入",
            attachmentUnsupported: "暂不支持此文件类型",
            attachmentDocumentUnsupported: "PDF 和 Word 文件暂不支持，请改用粘贴或文本文件。",
            attachmentError: "无法提取文字",
            removeAttachment: "移除",
            textFileImported: "已导入文本文件",
            configureKey: "配置 API 密钥以开始",
            localModeTitle: "本地练习已就绪",
            localModeDescription: "现在就能从你粘贴的材料直接开始一组短时提取练习，无需 AI 密钥；AI 是可选增强，仅用于生成额外任务。",
            startLocalQuest: "开始本地练习",
            connectAi: "连接 AI",
            localModePrivacy: "本地任务的题目全部来自你粘贴的材料；学习记录只保存在此设备，不会发送给 AI 服务。",
            localMaterialTitle: "从你的材料开始本地任务",
            localMaterialStart: "从这份材料开始本地任务",
            localMaterialHint: "完全在本机运行，无需 AI 密钥；题目全部来自你粘贴的原文。",
            briefTitle: "学习简报",
            briefLanguage: "材料语言",
            briefDifficulty: "难度带",
            briefTargets: "建议练习项",
            briefRemoveTarget: "移除练习项",
            briefRestoreTarget: "恢复练习项",
            briefMinTargets: "至少保留 3 个建议练习项才能开始。",
            briefStart: "开始任务",
            briefCancel: "取消",
            localQuestBuildError: "这份材料暂时无法组成完整的本地任务。请再补充几句原文，或改用 AI 任务。",
            aiOptionalHint: "AI 任务是可选增强；上方的本地任务无需密钥。",
            analyzing: "正在分析情报...",
            initialize: "初始化任务",
            error: "任务生成失败。请重试。",
            ...
            imageUpload: "或上传课本照片",
            imageHint: "图片会在浏览器本地识别，请在生成前检查并编辑识别文字。",
            imageUploadButton: "选择图片",
            imageProcessing: "正在识别文字...",
            imageDetected: "OCR 文本已插入，可先修改再生成。",
            imageReplace: "重新选择",
            imageStubText: "图片 OCR 文字",
            imageDemoNotice: "请在生成前检查并编辑识别文字。",
