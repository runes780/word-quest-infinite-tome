...
### 数据与算法
- [ ] 新增 mastery 聚合任务（按日或按会话）
- [ ] 定义 mastery 迁移规则（升/降级阈值）
- [ ] 引入低样本平滑，避免 mastery 抖动
- [ ] 题目调度加入 mastery 权重
...
### 验收
- [ ] 题型分布抽样 100 题符合 50/30/20
- [ ] 重复错因率较基线下降 >= 20%
- [ ] 新增测试：mastery 迁移与排序结果稳定
...
### 任务线系统
- [ ] 设计任务实体（目标/进度/期限/奖励/证据）
- [ ] 任务线 UI（主线 + 每日）
- [ ] 任务进度自动消费 `learningEvents`
